...
class InterestTimelineStepUpdater extends AbstractTimelineStepUpdater
{
	private const SYSTEM_COMMENT_NEGATIVE = 'Клиенту не подошли помещения, которые осмотрели. Разберите ситуацию, попробуйте понять причину и подберите новые предложения.';
	...
	private function addObjects(TimelineStep $step, array $objectDtos): void
	{
		...
		try {
			...
			$this->service->reopenOrCreateStep($step->timeline, TimelineStep::TALK_STEP_NUMBER);
