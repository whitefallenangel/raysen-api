...
class InspectionTimelineStepUpdater extends AbstractTimelineStepUpdater
{
	private const SYSTEM_COMMENT_NEGATIVE = 'Клиент передумал осматривать, заинтересовавшие его помещения, разберите ситуацию, попробуйте понять причину или подберите новые предложения.';
	...
	private function addObjects(TimelineStep $step, array $objectDtos): void
	{
		...
		try {
			...
			$this->service->reopenOrCreateStep($step->timeline, TimelineStep::VISIT_STEP_NUMBER);
