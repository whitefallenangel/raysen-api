...
class NotifyPreviousConsultantOnRequestConsultantChangedListener implements EventListenerInterface
{
	...
	public function handle(Event $event): void
	{
		...
		$consultant = $event->getOldConsultant();

		$this->sendNotification($this->requestNotificationFactory->reassigned($request, $consultant), $consultant);
	}
