...
class NotifyAssignedOnCreateTaskListener implements EventListenerInterface
{
	...
	public function handle(Event $event): void
	{
		...
		if ($task->user_id !== $task->created_by_id && !$task->isDone()) {
			$this->sendNotification($this->taskNotificationFactory->created($task), $task->user);
		}
