...
class CreateTaskListener implements EventListenerInterface
{
	...
	public function handle(Event $event): void
	{
		...
		// TODO: Уведомление пользователю по сокетам, что появилась новая задача
	}
	...
	{
		$this->taskEventService->create(TaskEvent::EVENT_TYPE_CREATED, $task->lastHistory);
	}
}