...
class AssignTaskListener implements EventListenerInterface
{
	...
	public function handle(Event $event): void
	{
		...
		// TODO: Уведомление пользователю по сокетам, что на него повесили задачу
	}
	...
	{
		$this->taskEventService->create(TaskEvent::EVENT_TYPE_ASSIGNED, $task->lastHistory);
	}
}