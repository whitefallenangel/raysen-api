...
/**
 * This is the model class for table "c_industry_floors".
 *
 * @property int $id
 ...
 */
class ObjectFloors extends \yii\db\ActiveRecord
{
    public const GATE_TYPE_DOCK = 1;
    public const GATE_TYPE_AT_ZERO = 2;
    public const GATE_TYPE_ON_RAMP = 3;
    public const GATE_TYPE_TRAIN_RAMP = 4;

    public const GATE_TYPE_LIST = [
        1 => "докового типа",
        2 => "нулевой уровень",
        3 => "авторампа",
        4 => "Ж/Д рампа",
