...
class CompanyWantsToBuyOrSellEquipmentSystemMessage extends AbstractChatMemberSystemMessage
{
	private ?int $surveyId = null;

	protected string $template = '%s  Компания хочет купить или продать оборудование. Подробнее в прикрепленном опросе %s.';
